...
--
-- Name: user_bookmarked_posts; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_bookmarked_posts (
    bookmark_job_id integer NOT NULL,
    user_id integer,
    job_post_id integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
ALTER TABLE public.user_bookmarked_posts OWNER TO postgres;
...
ALTER SEQUENCE public.user_favorite_posts_favorite_job_id_seq OWNED BY public.user_bookmarked_posts.bookmark_job_id;
...
--
-- Name: user_bookmarked_posts bookmark_job_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_bookmarked_posts ALTER COLUMN bookmark_job_id SET DEFAULT nextval('public.user_favorite_posts_favorite_job_id_seq'::regclass);
...
1	2	/dummy/path/dummy_resume.pdf	["Python", "FastAPI", "PostgreSQL"]	백엔드	2025-06-26 10:41:02.277946
\.
...
--
-- Data for Name: user_bookmarked_posts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_bookmarked_posts (bookmark_job_id, user_id, job_post_id, created_at) FROM stdin;
\.
...
--
-- Name: user_bookmarked_posts uq_bookmark; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_bookmarked_posts
    ADD CONSTRAINT uq_bookmark UNIQUE (user_id, job_post_id);


--
-- Name: user_bookmarked_posts user_favorite_posts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_bookmarked_posts
    ADD CONSTRAINT user_favorite_posts_pkey PRIMARY KEY (bookmark_job_id);
...
--
-- Name: user_bookmarked_posts user_favorite_posts_job_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_bookmarked_posts user_favorite_posts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
